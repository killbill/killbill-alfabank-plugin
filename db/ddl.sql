CREATE TABLE `alfabank_payment_methods` (
  ...
  PRIMARY KEY (`id`),
  KEY `index_alfabank_payment_methods_on_kb_account_id` (`kb_account_id`),
  KEY `index_alfabank_payment_methods_on_kb_payment_method_id` (`kb_payment_method_id`)
) ENGINE=InnoDB CHARACTER SET utf8 COLLATE utf8_bin;

CREATE TABLE `alfabank_transactions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `alfabank_response_id` int(11) NOT NULL,
  `api_call` varchar(255) NOT NULL,
  `kb_payment_id` varchar(255) NOT NULL,
  `alfabank_txn_id` varchar(255) NOT NULL,
  `amount_in_cents` int(11) NOT NULL,
  `currency` varchar(255) NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `index_alfabank_transactions_on_kb_payment_id` (`kb_payment_id`)
) ENGINE=InnoDB CHARACTER SET utf8 COLLATE utf8_bin;

CREATE TABLE `alfabank_responses` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `api_call` varchar(255) NOT NULL,
