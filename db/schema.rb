...
ActiveRecord::Schema.define(:version => 20140410153635) do
  create_table "alfabank_payment_methods", :force => true do |t|
    t.string   "kb_account_id",            :null => false
    t.string   "kb_payment_method_id"      # NULL before Kill Bill knows about it
    t.string   "alfabank_token"   # alfabank id
  ...
  add_index(:alfabank_payment_methods, :kb_account_id)
  add_index(:alfabank_payment_methods, :kb_payment_method_id)

  create_table "alfabank_transactions", :force => true do |t|
  ...
  add_index(:alfabank_transactions, :kb_payment_id)

  create_table "alfabank_responses", :force => true do |t|
    t.string   "api_call",          :null => false
